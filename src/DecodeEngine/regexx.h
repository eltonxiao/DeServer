...
namespace regexx
{
	//predefined patterns copy from zregx-1.04, JJL

    //IP address, octets returned in subgroups
    extern const std::string IP;

    //double-quoted string, with possible embedded \-escaped double quotes
    ...
    {
    public:
        inline RegexxMatchAtom(std::string& _str, std::string::size_type _start, std::string::size_type _length)
			: m_str(_str), m_start(_start), m_length(_length)
        {
        }

        inline RegexxMatchAtom& operator=(const RegexxMatchAtom& _rxxma)
        {
            m_str = _rxxma.m_str;
        ...
        inline const std::string::size_type& start() const
        {
            return m_start;
        }

        /// Length of the atom string.
        inline const std::string::size_type& length() const
        {
            return m_length;
        }
        ...
        inline bool operator==(const std::string& _s) const
        {
    ...
    {
    public:
        inline RegexxMatch(std::string& _str, std::string::size_type _start, std::string::size_type _length)
			: m_str(_str), m_start(_start), m_length(_length)
        {
        }

        inline RegexxMatch& operator=(const RegexxMatch& _rxxm)
        {
            m_str = _rxxm.m_str;
    ...
    public:
         ...
         *  @see operator int()
         */
        inline Regexx(const std::string& _str, const std::string& _expr, int _flags = 0) throw(CompileException)
			: m_compiled(false), m_study(false), m_extra(NULL), m_matches(0)
        {
         ...
         *  @see operator string()
         */
        inline Regexx(const std::string& _str, const std::string& _expr, const std::string& _repstr, int _flags = 0) throw(CompileException)
			: m_compiled(false), m_study(false), m_extra(NULL), m_matches(0)
        {
         ...
         */
        inline Regexx& expr(const std::string& _expr);
         ...
         *  @return Self reference.
         */
        inline Regexx& str(const std::string& _str);
         ...
         */
        const unsigned int& exec(int _flags = 0) throw(CompileException);
         ...
         *  @return Number of matches.
         */
        inline const unsigned int& exec(const std::string& _expr, int _flags = 0) throw(CompileException);

        /** Execute a regular expression.
         *  @return Number of matches.
         */
        inline const unsigned int& exec(const std::string& _str, const std::string& _expr, int _flags = 0) throw(CompileException);
         ...
         */
        const std::string& replace(const std::string& _repstr, int _flags = 0) throw(CompileException);
         ...
         *  @return Replaced string.
         */
        inline const std::string& replace(const std::string& _expr, const std::string& _repstr, int _flags = 0) throw(CompileException);

        /** Replace string with regular expression.
         *  @return Replaced string.
         */
        inline const std::string& replace(const std::string& _str, const std::string& _expr, const std::string& _repstr, int _flags = 0) throw(CompileException);
         ...
         *  @return Replaced string.
         */
        inline const std::string& replacef(std::string (*_func)(const RegexxMatch&) , int _flags = 0) throw(CompileException);
         ...
         *  @return Replaced string.
         */
        inline const std::string& replacef(const std::string& _expr, std::string (*_func)(const RegexxMatch&), int _flags = 0) throw(CompileException);
         ...
         *  @return Replaced string.
         */
        inline const std::string& replacef(const std::string& _str, const std::string& _expr, std::string (*_func)(const RegexxMatch&), int _flags = 0) throw(CompileException);
        ...
        inline const std::string& replaced() const
        {
            return m_replaced;
        }
    ...
    inline Regexx& Regexx::expr(const std::string& _expr)
    {
        if (m_compiled)
        {
            free(m_preg);
    ...
    inline Regexx& Regexx::str(const std::string& _str)
    {
        m_str = _str;
        return *this;
    }

    inline const unsigned int& Regexx::exec(const std::string& _expr, int _flags) throw(CompileException)
    {
        expr(_expr);
        return exec(_flags);
    }

    inline const unsigned int& Regexx::exec(const std::string& _str, const std::string& _expr, int _flags) throw(CompileException)
    {
        str(_str);
        expr(_expr);
        return exec(_flags);
    ...
    inline const std::string& Regexx::replace(const std::string& _expr, const std::string& _repstr, int _flags) throw(CompileException)
    {
        expr(_expr);
        return replace(_repstr,_flags);
    }

    inline const std::string& Regexx::replace(const std::string& _str, const std::string& _expr, const std::string& _repstr, int _flags) throw(CompileException)
    {
        str(_str);
        expr(_expr);
        return replace(_repstr,_flags);
    ...
    inline const std::string& Regexx::replacef(std::string (*_func)(const RegexxMatch&), int _flags) throw(CompileException)
    {
        exec(_flags & ~nomatch);
        m_replaced = m_str;
    ...
    inline const std::string& Regexx::replacef(const std::string& _expr, std::string (*_func)(const RegexxMatch&), int _flags) throw(CompileException)
    {
        expr(_expr);
        return replacef(_func, _flags);
    }

    inline const std::string& Regexx::replacef(const std::string& _str, const std::string& _expr, std::string (*_func)(const RegexxMatch&), int _flags) throw(CompileException)
    {
        str(_str);
        expr(_expr);
        return replacef(_func,_flags);
